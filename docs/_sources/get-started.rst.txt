...
.. code:: yaml
    ...
    # Reproduction command (with lincs version 2.0.0): lincs generate classification-problem 4 3 --random-seed 40
...
.. code:: yaml
    ...
    # Reproduction command (with lincs version 2.0.0): lincs generate classification-model problem.yml --random-seed 41 --model-type mrsort
...
.. code:: text
    ...
    # Reproduction command (with lincs version 2.0.0): lincs generate classified-alternatives problem.yml model.yml 1000 --random-seed 42 --misclassified-count 0
